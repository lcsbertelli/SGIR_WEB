...
import jpa.entities.Disciplina;
import jsf.util.JsfUtil;
import jsf.util.PaginationHelper;
import jpa.session.DisciplinaFacade;
...
public class DisciplinaController implements Serializable {
    ...
    private Disciplina current;
    private DataModel items = null;
    @EJB
    private jpa.session.DisciplinaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Disciplina) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("DisciplinaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("DisciplinaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("DisciplinaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class DisciplinaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Disciplina) {
                ...
                return getStringKey(o.getIdDisciplina());
            } else {
