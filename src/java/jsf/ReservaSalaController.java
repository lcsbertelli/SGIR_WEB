...
import jpa.session.ReservaSalaFacade;
...
public class ReservaSalaController implements Serializable {
    ...
    @EJB
    private jpa.session.ReservaSalaFacade ejbFacade;
    ...
    public ReservaSala getSelected() {
        if (current == null) {
            current = new ReservaSala();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ReservaSalaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ReservaSala) getItems().getRowData();
  ...
  //  else reservaValidateMsg="Data não disponivel";
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ReservaSalaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ReservaSalaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ReservaSala getReservaSala(java.lang.Integer id) {
    ...
    public static class ReservaSalaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ReservaSala) {
                ...
                return getStringKey(o.getIdReservaSala());
            } else {
